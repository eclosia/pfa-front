...
import { FiSearch, FiFilter, FiX, FiCheck, FiUpload, FiEdit2, FiCalendar, FiDollarSign, FiMapPin, FiBriefcase, FiClock, FiUser, FiMail, FiPhone, FiFileText } from "react-icons/fi";
  ...
  useEffect(() => {
    ...
    if (filters.search) {
      ...
      filtered = filtered.filter(offer =>
        ...
        offer.company.toLowerCase().includes(searchTerm) ||
        offer.description.toLowerCase().includes(searchTerm) ||
        offer.requirements.some(req => req.toLowerCase().includes(searchTerm))
      );
    }
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                            {offer.company} • <FiMapPin className="inline mr-1" />{offer.location}
                            {offer.remote && <span className="ml-2 text-green-600 dark:text-green-400">(Télétravail possible)</span>}
                          </p>
                          <div className="flex flex-wrap items-center gap-2 mb-3">
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                              offer.type === "Stage" ? "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400" :
                            ...
                            <span className="inline-flex items-center text-xs text-gray-500 dark:text-gray-400">
                              <FiClock className="mr-1" /> {offer.duration}
                            </span>
                            <span className="inline-flex items-center text-xs text-gray-500 dark:text-gray-400">
                              <FiCalendar className="mr-1" /> {offer.startDate}
                            </span>
                            {offer.salary && (
                              <span className="inline-flex items-center text-xs text-gray-500 dark:text-gray-400">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {offer.requirements.slice(0, 5).map((req, index) => (
                          <span
                            key={index}
              ...
              <>
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400 mb-1">
                    {selectedOfferDetails.company} • <FiMapPin className="inline mr-1" />
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                      selectedOfferDetails.type === "Stage" ? "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400" :
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                      <FiClock className="mr-1" /> {selectedOfferDetails.duration}
                    </span>
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                      <FiCalendar className="mr-1" /> Début : {selectedOfferDetails.startDate}
                    </span>
                  ...
                  <div className="col-span-2">
                    <div className="mb-6 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400">
                          Publié le {new Date(selectedOfferDetails.postedDate).toLocaleDateString('fr-FR', {
                            day: 'numeric',
                            month: 'long',
                            year: 'numeric'
                          })}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedOfferDetails.requirements.map((req, index) => (
                          <span
                            key={index}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 dark:text-gray-200">{selectedOfferDetails.duration}</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 dark:text-gray-200">{selectedOfferDetails.startDate}</p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          <FiClock className="w-5 h-5 text-gray-400 mr-3" />
                          <div>
                            ...
                            <p className="text-gray-800 dark:text-gray-200">
                              {selectedOfferDetails.postedDate ? new Date(selectedOfferDetails.postedDate).toLocaleDateString('fr-FR', {
                                day: 'numeric',
                                month: 'long',
                                year: 'numeric'
                              }) : 'Non spécifiée'}
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 dark:text-gray-200">{selectedOfferDetails.contact}</p>
                          </div>
                        </div>
                      </div>
